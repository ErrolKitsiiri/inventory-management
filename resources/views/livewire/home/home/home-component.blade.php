        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">We offer software solutions for growing your business</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">We are team of talented designers making websites and application using the latest technologies</h2>
    ...
    <main id="main">
        ...
        <section id="values" class="values">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <header class="section-header">
                    <h2>Our Values</h2>
                    <p>Trusted by clients countrywide since 2015</p>
                </header>
                ...
                <div class="row gy-4" data-aos="fade-left">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="box">
                            ...
                            <img src="{{ asset('front/assets/img/pricing-starter.png') }}" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
                        <div class="box">
                            ...
                            <img src="{{ asset('front/assets/img/pricing-business.png') }}" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
                        <div class="box">
                            ...
                            <img src="{{ asset('front/assets/img/pricing-ultimate.png') }}" class="img-fluid"
                                alt="">
                            <ul>
                                <li>Aida dere</li>
                                <li>Nec feugiat nisl</li>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <p>Card</p>
                                <div class="portfolio-links">
                                    <a href="front/img/portfolio/portfolio-7.jpg')}}" data-gallery="portfolioGallery"
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('front/assets/img/team/team-1.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('front/assets/img/team/team-2.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('front/assets/img/team/team-3.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="member">
                            <div class="member-img">
                                <img src="{{ asset('front/assets/img/team/team-4.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
        ...
        <section id="clients" class="clients">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <header class="section-header">
                    <h2>Our Clients</h2>
                    <p>Clients we have served so far</p>
                </header>
        ...
        <section id="recent-blog-posts" class="recent-blog-posts">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="post-box">
                            <div class="post-img"><img src="{{ asset('front/assets/img/blog/blog-1.jpg') }}"
                                    class="img-fluid" alt=""></div>
                    ...
                    <div class="col-lg-4">
                        <div class="post-box">
                            <div class="post-img"><img src="{{ asset('front/assets/img/blog/blog-2.jpg') }}"
                                    class="img-fluid" alt=""></div>
                    ...
                    <div class="col-lg-4">
                        <div class="post-box">
                            <div class="post-img"><img src="{{ asset('front/assets/img/blog/blog-3.jpg') }}"
                                    class="img-fluid" alt=""></div>
